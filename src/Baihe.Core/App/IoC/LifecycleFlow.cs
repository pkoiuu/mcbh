...
partial class Lifecycle
{
    ...
    public static void OnLoading()
    {
        ...
        // 显示主窗口
        CurrentApplication.ShowMainWindow();
    }
    ...
    /// <summary>
    /// 应用程序容器，在 <see cref="LifecycleState.BeforeLoading"/> 阶段为空值。
    /// 由宿主层 (Baihe.Host) 注入实现。
    /// </summary>
    public static IApplicationContainer CurrentApplication { get; set; } = null!;
