...
using Baihe.Core.Minecraft.IdentityModel.Extensions.JsonWebToken;
using Baihe.Core.Minecraft.IdentityModel.OAuth;
using Baihe.Core.Minecraft.IdentityModel;
using Baihe.Core.IO.Net.Http;

namespace Baihe.Core.Minecraft.IdentityModel.Extensions.OpenId;
